 ...
 */
class SingleTransactionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SingleTransactionResponse';
    ...
    public function setCode($code)
    {
        if (!is_null($code) && (mb_strlen($code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $code when calling SingleTransactionResponse., must be smaller than or equal to 3.');
        }
