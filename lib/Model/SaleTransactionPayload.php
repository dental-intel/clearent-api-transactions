...
/**
 * SaleTransactionPayload Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SaleTransactionPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SaleTransactionPayload';
    ...
    protected static $openAPITypes = [
        ...
        'type' => '\OpenAPI\Client\Model\TypeSaleTransaction',
    ...
    public function setPlatformFees($platform_fees)
    {
        ...
        if (!is_null($platform_fees) && (count($platform_fees) > 2)) {
            throw new \InvalidArgumentException('invalid value for $platform_fees when calling SaleTransactionPayload., number of items must be less than or equal to 2.');
        }
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\TypeSaleTransaction
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\TypeSaleTransaction $type type
     *
     * @return self
     */
