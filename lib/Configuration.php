...
namespace ClearentTransactionsApi;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://gateway-sb.clearent.net';
    ...
    {
        $report  = 'PHP SDK (ClearentTransactionsApi) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://gateway-sb.clearent.net",
                "description" => "No description provided",
            ],
            [
                "url" => "https://gateway.clearent.net",
                "description" => "No description provided",
            ]
        ];
    }
